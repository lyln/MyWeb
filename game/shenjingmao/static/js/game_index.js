...
function crossAjax(config){
    document.domain='h5game.wiredtiger.org'; //域名
    if(!$iframe){
    ...
    crossAjax({
        ...
        success:function(result){
            ...
            if(data.flag=='f0'||data.flag=='f1'){
                ...
                tem += '</div>';
                tem += '<a ontouchstart="" class="w_button w_button_small fl" id="gobackgame" href="h5game.wiredtiger.org" style="width: 50px; margin-top: 10px;">继续游戏</a>';
